...
#include <vector>
#include <memory>
#include "GLViewExampleVolumetricRayMarching.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewExampleVolumetricRayMarching > glView( Aftr::GLViewExampleVolumetricRayMarching::New( args ) );
